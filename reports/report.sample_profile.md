...
- [Low Issues](#low-issues)
  ...
  - [L-11: The `nonReentrant` `modifier` should occur before all other modifiers](#l-11-the-nonreentrant-modifier-should-occur-before-all-other-modifiers)
  - [L-12: Using `ERC721::_mint()` can be dangerous](#l-12-using-erc721mint-can-be-dangerous)
  - [L-13: PUSH0 is not supported by all chains](#l-13-push0-is-not-supported-by-all-chains)
  - [L-14: Modifiers invoked only once can be shoe-horned into the function](#l-14-modifiers-invoked-only-once-can-be-shoe-horned-into-the-function)
  - [L-15: Empty Block](#l-15-empty-block)
  - [L-16: Large literal values multiples of 10000 can be replaced with scientific notation](#l-16-large-literal-values-multiples-of-10000-can-be-replaced-with-scientific-notation)
  - [L-17: Internal functions called only once can be inlined](#l-17-internal-functions-called-only-once-can-be-inlined)
  - [L-18: Contract still has TODOs](#l-18-contract-still-has-todos)
  - [L-19: Inconsistency in declaring uint256/uint (or) int256/int variables within a contract](#l-19-inconsistency-in-declaring-uint256uint-or-int256int-variables-within-a-contract)
  - [L-20: Unused Custom Error](#l-20-unused-custom-error)
  - [L-21: Loop contains `require`/`revert` statements](#l-21-loop-contains-requirerevert-statements)
  - [L-22: Incorrect Order of Division and Multiplication](#l-22-incorrect-order-of-division-and-multiplication)
...
## L-11: The `nonReentrant` `modifier` should occur before all other modifiers
...
## L-12: Using `ERC721::_mint()` can be dangerous
...
## L-14: Modifiers invoked only once can be shoe-horned into the function
...
- Found in src/DeprecatedOZFunctions.sol [Line: 31](../tests/contract-playground/src/DeprecatedOZFunctions.sol#L31)

	```solidity
	    function approve(IERC20 token, address spender, uint256 value) external {
	```

- Found in src/DeprecatedOZFunctions.sol [Line: 36](../tests/contract-playground/src/DeprecatedOZFunctions.sol#L36)
...
## L-16: Large literal values multiples of 10000 can be replaced with scientific notation
...
## L-17: Internal functions called only once can be inlined
...
## L-19: Inconsistency in declaring uint256/uint (or) int256/int variables within a contract

Consider keeping the naming convention consistent in a given contract

- Found in src/Casting.sol [Line: 6](../tests/contract-playground/src/Casting.sol#L6)
...
## L-22: Incorrect Order of Division and Multiplication
