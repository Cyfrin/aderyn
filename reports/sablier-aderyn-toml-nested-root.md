...
- [Low Issues](#low-issues)
  ...
  - [L-8: State variable modification not logged in event](#l-8-state-variable-modification-not-logged-in-event)
...
## L-8: State variable modification not logged in event
