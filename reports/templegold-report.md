...
- [High Issues](#high-issues)
  ...
  - [H-10: Calls inside a loop might lead to a denial-of-service attack.](#h-10-calls-inside-a-loop-might-lead-to-a-denial-of-service-attack)
...
## H-7: Return value of the function call is not checked.
...
## H-9: Deletion from a nested mappping.
...
## H-10: Calls inside a loop might lead to a denial-of-service attack.

If one of the destinations has a fallback function that reverts, it will cause the whole transaction to revert. Favor pull over push for external calls.
...
- Found in contracts/core/OpsManager.sol [Line: 147](../tests/2024-07-templegold/protocol/contracts/core/OpsManager.sol#L147)
...
- Found in contracts/core/OpsManagerLib.sol [Line: 85](../tests/2024-07-templegold/protocol/contracts/core/OpsManagerLib.sol#L85)
...
- Found in contracts/v2/TreasuryReservesVault.sol [Line: 462](../tests/2024-07-templegold/protocol/contracts/v2/TreasuryReservesVault.sol#L462)
...
- Found in contracts/v2/strategies/GnosisStrategy.sol [Line: 163](../tests/2024-07-templegold/protocol/contracts/v2/strategies/GnosisStrategy.sol#L163)
