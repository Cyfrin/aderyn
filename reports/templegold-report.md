...
- Found in contracts/core/RebasingERC20.sol [Line: 49](../tests/2024-07-templegold/protocol/contracts/core/RebasingERC20.sol#L49)

	```solidity
	    function _update(address from, address to, uint256 value) internal virtual override {
	```

- Found in contracts/v2/access/TempleElevatedAccess.sol [Line: 38](../tests/2024-07-templegold/protocol/contracts/v2/access/TempleElevatedAccess.sol#L38)

	```solidity
	    constructor(address initialRescuer, address initialExecutor) {
	```

- Found in contracts/v2/strategies/AbstractStrategy.sol [Line: 39](../tests/2024-07-templegold/protocol/contracts/v2/strategies/AbstractStrategy.sol#L39)
