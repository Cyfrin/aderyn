...
- [Low Issues](#low-issues)
  ...
  - [L-19: State variable modification not logged in event](#l-19-state-variable-modification-not-logged-in-event)
  - [L-20: Redundant statements have no effect.](#l-20-redundant-statements-have-no-effect)
...
| Filepath | nSLOC |
| --- | --- |
| contracts/admin/TempleTeamPayments.sol | 80 |
...
| contracts/deprecated/LockedOGTemple.sol | 59 |
...
| contracts/governance/ElderElection.sol | 108 |
...
| contracts/templegold/TempleGoldStaking.sol | 354 |
...
| contracts/v2/interestRate/LinearWithKinkInterestRateModel.sol | 94 |
...
<details><summary>127 Found Instances</summary>
...
## L-19: State variable modification not logged in event
...
- Found in contracts/admin/TempleTeamPaymentsFactory.sol [Line: 42](../tests/2024-07-templegold/protocol/contracts/admin/TempleTeamPaymentsFactory.sol#L42)
...
- Found in contracts/amm/TempleUniswapV2Pair.sol [Line: 91](../tests/2024-07-templegold/protocol/contracts/amm/TempleUniswapV2Pair.sol#L91)

	```solidity
	        blockTimestampLast = blockTimestamp;
	```

- Found in contracts/amo/AuraStaking.sol [Line: 37](../tests/2024-07-templegold/protocol/contracts/amo/AuraStaking.sol#L37)
...
- Found in contracts/core/Exposure.sol [Line: 89](../tests/2024-07-templegold/protocol/contracts/core/Exposure.sol#L89)

	```solidity
	        reval += amount;
	```

- Found in contracts/core/JoiningFee.sol [Line: 21](../tests/2024-07-templegold/protocol/contracts/core/JoiningFee.sol#L21)
...
- Found in contracts/core/OtcOffer.sol [Line: 82](../tests/2024-07-templegold/protocol/contracts/core/OtcOffer.sol#L82)

	```solidity
	        offerPrice = _offerPrice;
	```

- Found in contracts/core/OtcOffer.sol [Line: 84](../tests/2024-07-templegold/protocol/contracts/core/OtcOffer.sol#L84)

	```solidity
	        minValidOfferPrice = _minValidOfferPrice;
	```

- Found in contracts/core/OtcOffer.sol [Line: 85](../tests/2024-07-templegold/protocol/contracts/core/OtcOffer.sol#L85)

	```solidity
	        maxValidOfferPrice = _maxValidOfferPrice;
	```

- Found in contracts/core/RebasingERC20.sol [Line: 54](../tests/2024-07-templegold/protocol/contracts/core/RebasingERC20.sol#L54)

	```solidity
	            totalShares += shares;
	```

- Found in contracts/core/RebasingERC20.sol [Line: 71](../tests/2024-07-templegold/protocol/contracts/core/RebasingERC20.sol#L71)

	```solidity
	                totalShares -= shares;
	```

- Found in contracts/core/Vault.sol [Line: 77](../tests/2024-07-templegold/protocol/contracts/core/Vault.sol#L77)
...
- Found in contracts/deprecated/TempleStaking.sol [Line: 60](../tests/2024-07-templegold/protocol/contracts/deprecated/TempleStaking.sol#L60)

	```solidity
	        epochSizeSeconds = _epochSizeSeconds;
	```

- Found in contracts/deprecated/TempleStaking.sol [Line: 61](../tests/2024-07-templegold/protocol/contracts/deprecated/TempleStaking.sol#L61)
...
- Found in contracts/fakes/v2/strategies/DsrBaseStrategyTestnet.sol [Line: 39](../tests/2024-07-templegold/protocol/contracts/fakes/v2/strategies/DsrBaseStrategyTestnet.sol#L39)
...
- Found in contracts/templegold/SpiceAuction.sol [Line: 65](../tests/2024-07-templegold/protocol/contracts/templegold/SpiceAuction.sol#L65)

	```solidity
	        name = _name;
	```

- Found in contracts/templegold/TempleGold.sol [Line: 122](../tests/2024-07-templegold/protocol/contracts/templegold/TempleGold.sol#L122)

	```solidity
	        distributionParams = _params;
	```

- Found in contracts/templegold/TempleGold.sol [Line: 133](../tests/2024-07-templegold/protocol/contracts/templegold/TempleGold.sol#L133)

	```solidity
	        vestingFactor = _factor;
	```

- Found in contracts/templegold/TempleGold.sol [Line: 244](../tests/2024-07-templegold/protocol/contracts/templegold/TempleGold.sol#L244)

	```solidity
	        _totalDistributed += mintAmount;
	```

- Found in contracts/v2/TempleDebtToken.sol [Line: 113](../tests/2024-07-templegold/protocol/contracts/v2/TempleDebtToken.sol#L113)

	```solidity
	        name = _name;
	```

- Found in contracts/v2/TempleDebtToken.sol [Line: 114](../tests/2024-07-templegold/protocol/contracts/v2/TempleDebtToken.sol#L114)

	```solidity
	        symbol = _symbol;
	```

- Found in contracts/v2/TempleDebtToken.sol [Line: 115](../tests/2024-07-templegold/protocol/contracts/v2/TempleDebtToken.sol#L115)

	```solidity
	        baseRate = _baseInterestRate;
	```

- Found in contracts/v2/TempleDebtToken.sol [Line: 203](../tests/2024-07-templegold/protocol/contracts/v2/TempleDebtToken.sol#L203)

	```solidity
	                totalPrincipal += _mintAmountUInt128;
	```

- Found in contracts/v2/TempleDebtToken.sol [Line: 461](../tests/2024-07-templegold/protocol/contracts/v2/TempleDebtToken.sol#L461)

	```solidity
	        estimatedTotalRiskPremiumInterest += riskPremiumInterestDelta;
	```

- Found in contracts/v2/TreasuryPriceIndexOracle.sol [Line: 63](../tests/2024-07-templegold/protocol/contracts/v2/TreasuryPriceIndexOracle.sol#L63)

	```solidity
	        maxTreasuryPriceIndexDelta = _maxTreasuryPriceIndexDelta;
	```

- Found in contracts/v2/TreasuryReservesVault.sol [Line: 151](../tests/2024-07-templegold/protocol/contracts/v2/TreasuryReservesVault.sol#L151)

	```solidity
	        tpiOracle = _tpiOracle;
	```

- Found in contracts/v2/access/TempleElevatedAccess.sol [Line: 43](../tests/2024-07-templegold/protocol/contracts/v2/access/TempleElevatedAccess.sol#L43)

	```solidity
	        rescuer = initialRescuer;
	```

- Found in contracts/v2/access/TempleElevatedAccess.sol [Line: 44](../tests/2024-07-templegold/protocol/contracts/v2/access/TempleElevatedAccess.sol#L44)

	```solidity
	        executor = initialExecutor;
	```

- Found in contracts/v2/circuitBreaker/TempleCircuitBreakerAllUsersPerPeriod.sol [Line: 106](../tests/2024-07-templegold/protocol/contracts/v2/circuitBreaker/TempleCircuitBreakerAllUsersPerPeriod.sol#L106)

	```solidity
	            bucketIndex = _nextBucketIndex;
	```

- Found in contracts/v2/safeGuards/ThresholdSafeGuard.sol [Line: 63](../tests/2024-07-templegold/protocol/contracts/v2/safeGuards/ThresholdSafeGuard.sol#L63)

	```solidity
	        defaultSignaturesThreshold = _defaultSignaturesThreshold;
	```

- Found in contracts/v2/strategies/AbstractStrategy.sol [Line: 45](../tests/2024-07-templegold/protocol/contracts/v2/strategies/AbstractStrategy.sol#L45)

	```solidity
	        strategyName = _strategyName;
	```

- Found in contracts/v2/templeLineOfCredit/TempleLineOfCredit.sol [Line: 352](../tests/2024-07-templegold/protocol/contracts/v2/templeLineOfCredit/TempleLineOfCredit.sol#L352)
...
## L-20: Redundant statements have no effect.
