...
- [High Issues](#high-issues)
  ...
  - [H-7: Contract has missing function implementations](#h-7-contract-has-missing-function-implementations)
...
## H-7: Contract has missing function implementations

There is at least 1 function in the base contracts of this contract that has not been implemented.

<details><summary>18 Found Instances</summary>


- Found in contracts/amo/AuraStaking.sol [Line: 13](../tests/2024-07-templegold/protocol/contracts/amo/AuraStaking.sol#L13)

	```solidity
	contract AuraStaking is IAuraStaking, TempleElevatedAccess {
	```

- Found in contracts/amo/test/RamosTestnetAuraStaking.sol [Line: 15](../tests/2024-07-templegold/protocol/contracts/amo/test/RamosTestnetAuraStaking.sol#L15)

	```solidity
	contract RamosTestnetAuraStaking is IAuraStaking, TempleElevatedAccess {
	```

- Found in contracts/fakes/v2/strategies/DsrBaseStrategyTestnet.sol [Line: 16](../tests/2024-07-templegold/protocol/contracts/fakes/v2/strategies/DsrBaseStrategyTestnet.sol#L16)

	```solidity
	contract DsrBaseStrategyTestnet is AbstractStrategy, ITempleBaseStrategy {
	```

- Found in contracts/templegold/DaiGoldAuction.sol [Line: 24](../tests/2024-07-templegold/protocol/contracts/templegold/DaiGoldAuction.sol#L24)

	```solidity
	contract DaiGoldAuction is IDaiGoldAuction, AuctionBase, TempleElevatedAccess {
	```

- Found in contracts/templegold/SpiceAuction.sol [Line: 24](../tests/2024-07-templegold/protocol/contracts/templegold/SpiceAuction.sol#L24)

	```solidity
	contract SpiceAuction is ISpiceAuction, AuctionBase {
	```

- Found in contracts/templegold/SpiceAuctionFactory.sol [Line: 16](../tests/2024-07-templegold/protocol/contracts/templegold/SpiceAuctionFactory.sol#L16)
...
- Found in contracts/v2/TreasuryPriceIndexOracle.sol [Line: 16](../tests/2024-07-templegold/protocol/contracts/v2/TreasuryPriceIndexOracle.sol#L16)

	```solidity
	contract TreasuryPriceIndexOracle is ITreasuryPriceIndexOracle, TempleElevatedAccess {
	```

- Found in contracts/v2/TreasuryReservesVault.sol [Line: 46](../tests/2024-07-templegold/protocol/contracts/v2/TreasuryReservesVault.sol#L46)

	```solidity
	contract TreasuryReservesVault is ITreasuryReservesVault, TempleElevatedAccess {
	```

- Found in contracts/v2/circuitBreaker/TempleCircuitBreakerAllUsersPerPeriod.sol [Line: 28](../tests/2024-07-templegold/protocol/contracts/v2/circuitBreaker/TempleCircuitBreakerAllUsersPerPeriod.sol#L28)

	```solidity
	contract TempleCircuitBreakerAllUsersPerPeriod is ITempleCircuitBreaker, TempleElevatedAccess {
	```

- Found in contracts/v2/circuitBreaker/TempleCircuitBreakerProxy.sol [Line: 17](../tests/2024-07-templegold/protocol/contracts/v2/circuitBreaker/TempleCircuitBreakerProxy.sol#L17)

	```solidity
	contract TempleCircuitBreakerProxy is ITempleCircuitBreakerProxy, TempleElevatedAccess {
	```

- Found in contracts/v2/interestRate/LinearWithKinkInterestRateModel.sol [Line: 14](../tests/2024-07-templegold/protocol/contracts/v2/interestRate/LinearWithKinkInterestRateModel.sol#L14)

	```solidity
	contract LinearWithKinkInterestRateModel is BaseInterestRateModel, TempleElevatedAccess {
	```

- Found in contracts/v2/strategies/DsrBaseStrategy.sol [Line: 20](../tests/2024-07-templegold/protocol/contracts/v2/strategies/DsrBaseStrategy.sol#L20)

	```solidity
	contract DsrBaseStrategy is AbstractStrategy, ITempleBaseStrategy {
	```

- Found in contracts/v2/strategies/GnosisStrategy.sol [Line: 11](../tests/2024-07-templegold/protocol/contracts/v2/strategies/GnosisStrategy.sol#L11)

	```solidity
	contract GnosisStrategy is AbstractStrategy {
	```

- Found in contracts/v2/strategies/RamosStrategy.sol [Line: 22](../tests/2024-07-templegold/protocol/contracts/v2/strategies/RamosStrategy.sol#L22)

	```solidity
	contract RamosStrategy  is AbstractStrategy, IRamosTokenVault {
	```

- Found in contracts/v2/strategies/TempleTokenBaseStrategy.sol [Line: 16](../tests/2024-07-templegold/protocol/contracts/v2/strategies/TempleTokenBaseStrategy.sol#L16)

	```solidity
	contract TempleTokenBaseStrategy is AbstractStrategy, ITempleBaseStrategy {
	```

- Found in contracts/v2/strategies/TlcStrategy.sol [Line: 19](../tests/2024-07-templegold/protocol/contracts/v2/strategies/TlcStrategy.sol#L19)

	```solidity
	contract TlcStrategy is ITlcStrategy, AbstractStrategy {
	```

- Found in contracts/v2/templeLineOfCredit/TempleLineOfCredit.sol [Line: 29](../tests/2024-07-templegold/protocol/contracts/v2/templeLineOfCredit/TempleLineOfCredit.sol#L29)
