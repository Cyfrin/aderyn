...
- [Low Issues](#low-issues)
  ...
  - [L-5: Use < instead of <=](#l-5-use--instead-of-)
...
- Found in src/sd59x18/Helpers.sol [Line: 54](../tests/prb-math/src/sd59x18/Helpers.sol#L54)

	```solidity
	    result = x.unwrap() <= y.unwrap();
	```

- Found in src/sd59x18/Math.sol [Line: 494](../tests/prb-math/src/sd59x18/Math.sol#L494)

	```solidity
	    if (xInt <= 0) {
	```

- Found in src/ud60x18/Helpers.sol [Line: 55](../tests/prb-math/src/ud60x18/Helpers.sol#L55)
