...
- [High Issues](#high-issues)
  ...
  - [H-2: Incorrect Assembly Shift Parameter Order](#h-2-incorrect-assembly-shift-parameter-order)
...
- Found in src/Common.sol [Line: 324](../tests/prb-math/src/Common.sol#L324)

	```solidity
	        x := shr(factor, x)
	```

- Found in src/Common.sol [Line: 330](../tests/prb-math/src/Common.sol#L330)

	```solidity
	        x := shr(factor, x)
	```

- Found in src/Common.sol [Line: 336](../tests/prb-math/src/Common.sol#L336)

	```solidity
	        x := shr(factor, x)
	```

- Found in src/Common.sol [Line: 342](../tests/prb-math/src/Common.sol#L342)

	```solidity
	        x := shr(factor, x)
	```

- Found in src/Common.sol [Line: 348](../tests/prb-math/src/Common.sol#L348)

	```solidity
	        x := shr(factor, x)
	```

- Found in src/Common.sol [Line: 354](../tests/prb-math/src/Common.sol#L354)

	```solidity
	        x := shr(factor, x)
	```

- Found in src/Common.sol [Line: 360](../tests/prb-math/src/Common.sol#L360)
