...
- [Low Issues](#low-issues)
  ...
  - [L-3: State variable modification not logged in event](#l-3-state-variable-modification-not-logged-in-event)
...
## L-3: State variable modification not logged in event
