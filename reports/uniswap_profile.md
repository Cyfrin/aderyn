...
- [Low Issues](#low-issues)
  ...
  - [L-3: State variable changes but no event is emitted.](#l-3-state-variable-changes-but-no-event-is-emitted)
...
## L-3: State variable changes but no event is emitted.
