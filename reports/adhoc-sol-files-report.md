...
- [Low Issues](#low-issues)
  ...
  - [L-17: State variable modification not logged in event](#l-17-state-variable-modification-not-logged-in-event)
...
- Found in InternalFunctions.sol [Line: 30](../tests/adhoc-sol-files/InternalFunctions.sol#L30)
