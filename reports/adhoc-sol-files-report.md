...
- [High Issues](#high-issues)
  - [H-1: Delegatecall made to an arbitrary address](#h-1-delegatecall-made-to-an-arbitrary-address)
...
- [Low Issues](#low-issues)
  ...
  - [L-16: Inconsistent uint256/uint (or) int256/int types](#l-16-inconsistent-uint256uint-or-int256int-types)
...
## H-1: Delegatecall made to an arbitrary address
...
## L-16: Inconsistent uint256/uint (or) int256/int types
