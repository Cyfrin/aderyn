...
- [Low Issues](#low-issues)
  ...
  - [L-5: State variable changes but no event is emitted.](#l-5-state-variable-changes-but-no-event-is-emitted)
...
## L-5: State variable changes but no event is emitted.
