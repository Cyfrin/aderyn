...
- [High Issues](#high-issues)
  ...
  - [H-2: `abi.encodePacked()` Hash Collision](#h-2-abiencodepacked-hash-collision)
  ...
  - [H-5: Dangerous strict equality checks on contract balances](#h-5-dangerous-strict-equality-checks-on-contract-balances)
  - [H-6: Dangerous unary operator](#h-6-dangerous-unary-operator)
  - [H-7: `delegatecall` to an Arbitrary Address](#h-7-delegatecall-to-an-arbitrary-address)
  - [H-8: Deletion from a nested mapping](#h-8-deletion-from-a-nested-mapping)
  - [H-9: Direct assignment of array length](#h-9-direct-assignment-of-array-length)
  - [H-10: EnumerableSet.remove Corrupts Order](#h-10-enumerablesetremove-corrupts-order)
  ...
  - [H-13: Incorrect ERC20 interface](#h-13-incorrect-erc20-interface)
  - [H-14: Incorrect ERC721 interface](#h-14-incorrect-erc721-interface)
  - [H-15: Incorrect Assembly Shift Parameter Order](#h-15-incorrect-assembly-shift-parameter-order)
  - [H-16: Incorrect use of caret operator](#h-16-incorrect-use-of-caret-operator)
  ...
  - [H-27: ETH transferred without address checks](#h-27-eth-transferred-without-address-checks)
  ...
  - [H-30: Signed integer array in storage (solc `<0.5.10`)](#h-30-signed-integer-array-in-storage-solc-0510)
...
- [Low Issues](#low-issues)
  ...
  - [L-6: Centralization Risk](#l-6-centralization-risk)
  - [L-7: Constant Function Contains Assembly](#l-7-constant-function-contains-assembly)
  - [L-8: Costly operations inside loop](#l-8-costly-operations-inside-loop)
  - [L-9: Dead Code](#l-9-dead-code)
  - [L-10: `delegatecall` in loop](#l-10-delegatecall-in-loop)
  - [L-11: Deprecated OpenZeppelin Function](#l-11-deprecated-openzeppelin-function)
  - [L-12: Incorrect Order of Division and Multiplication](#l-12-incorrect-order-of-division-and-multiplication)
  - [L-13: `ecrecover` Signature Malleability](#l-13-ecrecover-signature-malleability)
  - [L-14: Empty Block](#l-14-empty-block)
  - [L-15: Empty `require()` / `revert()` Statement](#l-15-empty-require--revert-statement)
  - [L-16: Function Used to Initialize State Variable](#l-16-function-used-to-initialize-state-variable)
  - [L-17: Function Pointer in Constructor](#l-17-function-pointer-in-constructor)
  - [L-18: Inconsistent uint256/uint (or) int256/int types](#l-18-inconsistent-uint256uint-or-int256int-types)
  - [L-19: Incorrect Use Of Modifier](#l-19-incorrect-use-of-modifier)
  - [L-20: Internal Function Used Only Once](#l-20-internal-function-used-only-once)
  - [L-21: Large Numeric Literal](#l-21-large-numeric-literal)
  - [L-22: Literal Instead of Constant](#l-22-literal-instead-of-constant)
  - [L-23: Local Variable Shadows State Variable](#l-23-local-variable-shadows-state-variable)
  - [L-24: Missing Inheritance](#l-24-missing-inheritance)
  - [L-25: Modifier Invoked Only Once](#l-25-modifier-invoked-only-once)
  - [L-26: Multiple Placeholders in Modifier](#l-26-multiple-placeholders-in-modifier)
  - [L-27: `nonReentrant` is Not the First Modifier](#l-27-nonreentrant-is-not-the-first-modifier)
  - [L-28: PUSH0 Opcode](#l-28-push0-opcode)
  - [L-29: Redundant Statement](#l-29-redundant-statement)
  - [L-30: Loop Contains `require`/`revert`](#l-30-loop-contains-requirerevert)
  - [L-31: Return Bomb](#l-31-return-bomb)
  - [L-32: Solmate's SafeTransferLib](#l-32-solmates-safetransferlib)
  - [L-33: Address State Variable Set Without Checks](#l-33-address-state-variable-set-without-checks)
  - [L-34: State Change Without Event](#l-34-state-change-without-event)
  - [L-35: State Variable Could Be Constant](#l-35-state-variable-could-be-constant)
  - [L-36: State Variable Could Be Immutable](#l-36-state-variable-could-be-immutable)
  - [L-37: State Variable is Read as External](#l-37-state-variable-is-read-as-external)
...
## H-2: `abi.encodePacked()` Hash Collision
...
## H-5: Dangerous strict equality checks on contract balances
...
## H-7: `delegatecall` to an Arbitrary Address
...
## H-8: Deletion from a nested mapping
...
## H-9: Direct assignment of array length
...
## H-10: EnumerableSet.remove Corrupts Order
...
## H-13: Incorrect ERC20 interface
...
## H-14: Incorrect ERC721 interface
...
## H-15: Incorrect Assembly Shift Parameter Order
...
## H-16: Incorrect use of caret operator
...
## H-27: ETH transferred without address checks
...
## H-30: Signed integer array in storage (solc `<0.5.10`)
...
## L-7: Constant Function Contains Assembly
...
## L-11: Deprecated OpenZeppelin Function
...
## L-13: `ecrecover` Signature Malleability
...
## L-15: Empty `require()` / `revert()` Statement
...
## L-16: Function Used to Initialize State Variable
...
## L-17: Function Pointer in Constructor
...
## L-18: Inconsistent uint256/uint (or) int256/int types
...
## L-19: Incorrect Use Of Modifier
...
## L-20: Internal Function Used Only Once
...
## L-22: Literal Instead of Constant
...
## L-23: Local Variable Shadows State Variable
...
## L-25: Modifier Invoked Only Once
...
## L-26: Multiple Placeholders in Modifier
...
## L-27: `nonReentrant` is Not the First Modifier
...
## L-30: Loop Contains `require`/`revert`
...
## L-32: Solmate's SafeTransferLib
...
## L-34: State Change Without Event
...
## L-35: State Variable Could Be Constant
...
## L-36: State Variable Could Be Immutable
...
## L-37: State Variable is Read as External
