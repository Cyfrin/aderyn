...
- [Low Issues](#low-issues)
  ...
  - [L-24: Use < instead of <=](#l-24-use--instead-of-)
...
- Found in src/LtInsteadOfLe.sol [Line: 5](../tests/contract-playground/src/LtInsteadOfLe.sol#L5)

	```solidity
	    function lessThan() public pure returns (bool) {
	```

- Found in src/LtInsteadOfLe.sol [Line: 9](../tests/contract-playground/src/LtInsteadOfLe.sol#L9)
...
- Found in src/LtInsteadOfLe.sol [Line: 2](../tests/contract-playground/src/LtInsteadOfLe.sol#L2)
...
- Found in src/LtInsteadOfLe.sol [Line: 10](../tests/contract-playground/src/LtInsteadOfLe.sol#L10)

	```solidity
	        return 1 <= 2;
	```

- Found in src/StorageConditionals.sol [Line: 65](../tests/contract-playground/src/StorageConditionals.sol#L65)

	```solidity
	        if (number <= s_differentConditionals) {
	```

- Found in src/eth2/DepositContract.sol [Line: 104](../tests/contract-playground/src/eth2/DepositContract.sol#L104)
