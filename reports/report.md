...
- Found in src/ReinitializerTest.sol [Line: 55](../tests/contract-playground/src/ReinitializerTest.sol#L55)
...
- Found in src/ReinitializerTest.sol [Line: 20](../tests/contract-playground/src/ReinitializerTest.sol#L20)

	```solidity
	    modifier initializer() {
	```

- Found in src/ReinitializerTest.sol [Line: 31](../tests/contract-playground/src/ReinitializerTest.sol#L31)
...
- Found in src/ReinitializerTest.sol [Line: 43](../tests/contract-playground/src/ReinitializerTest.sol#L43)

	```solidity
	    function initialize() external initializer {
	```

- Found in src/ReinitializerTest.sol [Line: 49](../tests/contract-playground/src/ReinitializerTest.sol#L49)
