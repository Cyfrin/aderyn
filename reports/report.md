...
| src/UninitializedLocalVariables.sol | 45 |
...
- Found in src/UninitializedLocalVariables.sol [Line: 42](../tests/contract-playground/src/UninitializedLocalVariables.sol#L42)

	```solidity
	            string memory combinedString = string(abi.encodePacked(initializedString, uninitializedString));
	```

- Found in src/UninitializedLocalVariables.sol [Line: 50](../tests/contract-playground/src/UninitializedLocalVariables.sol#L50)
...
- Found in src/UninitializedLocalVariables.sol [Line: 28](../tests/contract-playground/src/UninitializedLocalVariables.sol#L28)

	```solidity
	        uint[1] memory initializedUintArray = [uint(2)];
	```

- Found in src/UninitializedLocalVariables.sol [Line: 37](../tests/contract-playground/src/UninitializedLocalVariables.sol#L37)
...
- Found in src/UninitializedLocalVariables.sol [Line: 54](../tests/contract-playground/src/UninitializedLocalVariables.sol#L54)
