...
| src/StateVariablesManipulation.sol | 241 |
...
- Found in src/StateVariablesManipulation.sol [Line: 181](../tests/contract-playground/src/StateVariablesManipulation.sol#L181)

	```solidity
	        p.age = 200;
	```

- Found in src/StateVariablesManipulation.sol [Line: 191](../tests/contract-playground/src/StateVariablesManipulation.sol#L191)

	```solidity
	        p2.age = 200;
	```

- Found in src/StateVariablesManipulation.sol [Line: 222](../tests/contract-playground/src/StateVariablesManipulation.sol#L222)

	```solidity
	        uint256[5][1] memory m_allAges;
	```

- Found in src/StateVariablesManipulation.sol [Line: 226](../tests/contract-playground/src/StateVariablesManipulation.sol#L226)

	```solidity
	        m_person = Person("Spiderman", 21);
	```

- Found in src/StateVariablesManipulation.sol [Line: 228](../tests/contract-playground/src/StateVariablesManipulation.sol#L228)
...
- Found in src/StateVariablesManipulation.sol [Line: 247](../tests/contract-playground/src/StateVariablesManipulation.sol#L247)
...
- Found in src/StateVariablesManipulation.sol [Line: 322](../tests/contract-playground/src/StateVariablesManipulation.sol#L322)

	```solidity
	        p.some.push(102);
	```

- Found in src/StateVariablesManipulation.sol [Line: 328](../tests/contract-playground/src/StateVariablesManipulation.sol#L328)
