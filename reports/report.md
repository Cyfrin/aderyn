...
- [High Issues](#high-issues)
  ...
  - [H-34: Calls inside a loop might lead to a denial-of-service attack.](#h-34-calls-inside-a-loop-might-lead-to-a-denial-of-service-attack)
  - [H-35: Potential use of `tx.origin` for authentication.](#h-35-potential-use-of-txorigin-for-authentication)
  - [H-36: Loop contains `msg.value`.](#h-36-loop-contains-msgvalue)
  - [H-37: Contract locks Ether without a withdraw function.](#h-37-contract-locks-ether-without-a-withdraw-function)
...
| src/HighLevelCallsInsideLoop.sol | 37 |
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 7](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L7)

	```solidity
	    function bad() external {
	```

- Found in src/HighLevelCallsInsideLoop.sol [Line: 14](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L14)
...
## H-34: Calls inside a loop might lead to a denial-of-service attack.
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 9](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L9)

	```solidity
	        for (uint i = 0; i < destinations.length; i++) {
	```

- Found in src/HighLevelCallsInsideLoop.sol [Line: 16](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L16)

	```solidity
	        for (uint i = 0; i < destinations.length; i++) {
	```

- Found in src/HighLevelCallsInsideLoop.sol [Line: 27](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L27)

	```solidity
	        for (uint i = 0; i < destinations.length; i++) {
	```

- Found in src/HighLevelCallsInsideLoop.sol [Line: 37](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L37)
...
## H-35: Potential use of `tx.origin` for authentication.
...
## H-37: Contract locks Ether without a withdraw function.
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 10](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L10)

	```solidity
	            destinations[i].transfer(i);
	```

- Found in src/HighLevelCallsInsideLoop.sol [Line: 22](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L22)
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 2](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L2)
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 47](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L47)
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 54](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L54)
...
- Found in src/HighLevelCallsInsideLoop.sol [Line: 21](../tests/contract-playground/src/HighLevelCallsInsideLoop.sol#L21)
