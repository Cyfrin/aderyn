...
- [High Issues](#high-issues)
  ...
  - [H-22: Functions send eth away from contract but performs no checks on any address.](#h-22-functions-send-eth-away-from-contract-but-performs-no-checks-on-any-address)
  ...
  - [H-34: Potential use of `tx.origin` for authentication.](#h-34-potential-use-of-txorigin-for-authentication)
  - [H-35: Loop contains `msg.value`.](#h-35-loop-contains-msgvalue)
  - [H-36: Contract locks Ether without a withdraw function.](#h-36-contract-locks-ether-without-a-withdraw-function)
  - [H-37: Incorrect ERC721 interface.](#h-37-incorrect-erc721-interface)
  - [H-38: Incorrect ERC20 interface.](#h-38-incorrect-erc20-interface)
  - [H-39: Out of order retryable transactions.](#h-39-out-of-order-retryable-transactions)
  - [H-40: Constant functions changing state](#h-40-constant-functions-changing-state)
  - [H-41: Function selector collides with other functions](#h-41-function-selector-collides-with-other-functions)
  - [H-42: Unchecked Low level calls](#h-42-unchecked-low-level-calls)
- [Low Issues](#low-issues)
  ...
  - [L-26: Potentially unused `private` / `internal` state variables found.](#l-26-potentially-unused-private--internal-state-variables-found)
  - [L-27: Functions declared `pure` / `view` but contains assembly](#l-27-functions-declared-pure--view-but-contains-assembly)
  - [L-28: Boolean equality is not required.](#l-28-boolean-equality-is-not-required)
  - [L-29: Local variable shadows state variables in the contract hirearchy](#l-29-local-variable-shadows-state-variables-in-the-contract-hirearchy)
  - [L-30: Uninitialized local variables.](#l-30-uninitialized-local-variables)
  - [L-31: Return Bomb](#l-31-return-bomb)
  - [L-32: Function initializing state.](#l-32-function-initializing-state)
  - [L-33: Dead Code](#l-33-dead-code)
  - [L-34: Loop condition contains `state_variable.length` that could be cached outside.](#l-34-loop-condition-contains-statevariablelength-that-could-be-cached-outside)
  - [L-35: Incorrect use of `assert()`](#l-35-incorrect-use-of-assert)
  - [L-36: Costly operations inside loops.](#l-36-costly-operations-inside-loops)
  - [L-37: Builtin Symbol Shadowing](#l-37-builtin-symbol-shadowing)
  - [L-38: State variable could be declared constant](#l-38-state-variable-could-be-declared-constant)
  - [L-39: State variable changes but no event is emitted.](#l-39-state-variable-changes-but-no-event-is-emitted)
...
| src/StateVariablesChangesWithoutEvents.sol | 78 |
...
- Found in src/LocalVariableShadow.sol [Line: 25](../tests/contract-playground/src/LocalVariableShadow.sol#L25)
...
## H-22: Functions send eth away from contract but performs no checks on any address.
...
## H-34: Potential use of `tx.origin` for authentication.
...
## H-36: Contract locks Ether without a withdraw function.
...
## H-37: Incorrect ERC721 interface.
...
## H-38: Incorrect ERC20 interface.
...
## H-39: Out of order retryable transactions.
...
## H-40: Constant functions changing state
...
## H-42: Unchecked Low level calls
...
- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 18](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L18)

	```solidity
	    event variableChanged(uint outcome);
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 19](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L19)

	```solidity
	    event variableChanged2(bool outcome);
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 20](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L20)

	```solidity
	    event AddressChanged(address outcome);
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 21](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L21)

	```solidity
	    event MyStructChanged(MyStruct outcome);
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 22](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L22)
...
- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 7](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L7)

	```solidity
	        uint a;
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 8](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L8)

	```solidity
	        uint b;
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 11](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L11)
...
- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 24](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L24)
...
- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 61](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L61)

	```solidity
	    function wholeStructChangedEventNotEmitted(uint a, uint b) external { // bad
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 67](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L67)

	```solidity
	    function wholeStructChangedEventEmitted(uint a, uint b) external { // good
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 73](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L73)

	```solidity
	    function structMemberChangedEventNotEmitted(uint a, uint b) external { // bad
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 78](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L78)

	```solidity
	    function structMemberChangedEventEmitted(uint a) external { // good
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 83](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L83)

	```solidity
	    function stateChangedEventEmitted(uint a) external { // good
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 90](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L90)

	```solidity
	    function stateChangedEventEmittedForLocal(uint a) external { // good
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 96](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L96)

	```solidity
	    function stateChangedEventEmittedForLocalEquals(uint a) external { // good
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 102](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L102)

	```solidity
	    function noStateChangedNoEventEmitted(uint a) external pure returns(uint){ // good
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 103](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L103)
...
## L-26: Potentially unused `private` / `internal` state variables found.
...
## L-28: Boolean equality is not required.
...
## L-29: Local variable shadows state variables in the contract hirearchy
...
## L-30: Uninitialized local variables.
...
## L-32: Function initializing state.
...
## L-34: Loop condition contains `state_variable.length` that could be cached outside.
...
## L-36: Costly operations inside loops.
...
## L-38: State variable could be declared constant
...
## L-39: State variable changes but no event is emitted.
...
- Found in src/Casting.sol [Line: 30](../tests/contract-playground/src/Casting.sol#L30)
...
- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 32](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L32)

	```solidity
	    function stateChangedToBooleanNoEventEmitted() external { // bad
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 42](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L42)

	```solidity
	    function stateChangedToConstantNoEventEmitted() external { // bad
	```

- Found in src/StateVariablesChangesWithoutEvents.sol [Line: 46](../tests/contract-playground/src/StateVariablesChangesWithoutEvents.sol#L46)
...
- Found in src/UnprotectedInitialize.sol [Line: 25](../tests/contract-playground/src/UnprotectedInitialize.sol#L25)
