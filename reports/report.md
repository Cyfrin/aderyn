...
- Found in src/StateVariableEvents.sol [Line: 14](../tests/contract-playground/src/StateVariableEvents.sol#L14)
...
- Found in src/AbstractContract.sol [Line: 11](../tests/contract-playground/src/AbstractContract.sol#L11)
...
- Found in src/Counter.sol [Line: 8](../tests/contract-playground/src/Counter.sol#L8)

	```solidity
	        number = newNumber;
	```

- Found in src/Counter.sol [Line: 29](../tests/contract-playground/src/Counter.sol#L29)
...
- Found in src/InternalFunctions.sol [Line: 25](../tests/contract-playground/src/InternalFunctions.sol#L25)

	```solidity
	        value = _newValue;
	```

- Found in src/InternalFunctions.sol [Line: 30](../tests/contract-playground/src/InternalFunctions.sol#L30)
...
- Found in src/StateVariableEvents.sol [Line: 25](../tests/contract-playground/src/StateVariableEvents.sol#L25)

	```solidity
	        result2 = a;
	```

- Found in src/StateVariableEvents.sol [Line: 36](../tests/contract-playground/src/StateVariableEvents.sol#L36)

	```solidity
	        myStruct = temp;
	```

- Found in src/StateVariables.sol [Line: 49](../tests/contract-playground/src/StateVariables.sol#L49)

	```solidity
	        addr = newAddr;
	```

- Found in src/StateVariables.sol [Line: 54](../tests/contract-playground/src/StateVariables.sol#L54)
...
- Found in src/StateVariables.sol [Line: 66](../tests/contract-playground/src/StateVariables.sol#L66)

	```solidity
	        emptyAlteredPrivateNumber = _emptyAlteredPrivateNumber;
	```

- Found in src/StateVariables.sol [Line: 67](../tests/contract-playground/src/StateVariables.sol#L67)

	```solidity
	        emptyAlteredInternalNumber = _emptyAlteredInternalNumber;
	```

- Found in src/StateVariables.sol [Line: 68](../tests/contract-playground/src/StateVariables.sol#L68)

	```solidity
	        emptyAlteredPublicNumber = _emptyAlteredPublicNumber;
	```

- Found in src/StateVariables.sol [Line: 76](../tests/contract-playground/src/StateVariables.sol#L76)

	```solidity
	        nonEmptyAlteredPrivateNumber = _nonEmptyAlteredPrivateNumber;
	```

- Found in src/StateVariables.sol [Line: 77](../tests/contract-playground/src/StateVariables.sol#L77)

	```solidity
	        nonEmptyAlteredInternalNumber = _nonEmptyAlteredInternalNumber;
	```

- Found in src/StateVariables.sol [Line: 78](../tests/contract-playground/src/StateVariables.sol#L78)

	```solidity
	        nonEmptyAlteredPublicNumber = _nonEmptyAlteredPublicNumber;
	```

- Found in src/StorageConditionals.sol [Line: 9](../tests/contract-playground/src/StorageConditionals.sol#L9)

	```solidity
	        s_sameConditionals = same;
	```

- Found in src/StorageConditionals.sol [Line: 10](../tests/contract-playground/src/StorageConditionals.sol#L10)

	```solidity
	        s_differentConditionals = different;
	```

- Found in src/TestERC20.sol [Line: 26](../tests/contract-playground/src/TestERC20.sol#L26)

	```solidity
	        symbol = _symbol;
	```

- Found in src/TestERC20.sol [Line: 27](../tests/contract-playground/src/TestERC20.sol#L27)

	```solidity
	        name = _name;
	```

- Found in src/ZeroAddressCheck.sol [Line: 14](../tests/contract-playground/src/ZeroAddressCheck.sol#L14)

	```solidity
	        addr = newAddr;
	```

- Found in src/ZeroAddressCheck.sol [Line: 19](../tests/contract-playground/src/ZeroAddressCheck.sol#L19)

	```solidity
	        addr = newAddr;
	```

- Found in src/ZeroAddressCheck.sol [Line: 34](../tests/contract-playground/src/ZeroAddressCheck.sol#L34)

	```solidity
	        token = newToken;
	```

- Found in src/ZeroAddressCheck.sol [Line: 39](../tests/contract-playground/src/ZeroAddressCheck.sol#L39)
...
- Found in src/auditor_mode/ExternalCalls.sol [Line: 14](../tests/contract-playground/src/auditor_mode/ExternalCalls.sol#L14)

	```solidity
	        target = setTarget;
	```

- Found in src/nested/1/Nested.sol [Line: 11](../tests/contract-playground/src/nested/1/Nested.sol#L11)

	```solidity
	        numberOfHorses = newNumberOfHorses;
	```

- Found in src/nested/2/Nested.sol [Line: 11](../tests/contract-playground/src/nested/2/Nested.sol#L11)

	```solidity
	        numberOfHorses = newNumberOfHorses;
	```

- Found in src/parent_chain/ParentChainContract.sol [Line: 18](../tests/contract-playground/src/parent_chain/ParentChainContract.sol#L18)
