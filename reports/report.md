...
- [Low Issues](#low-issues)
  ...
  - [L-35: Unused Imports](#l-35-unused-imports)
...
- Found in src/U2.sol [Line: 3](../tests/contract-playground/src/U2.sol#L3)

	```solidity
	pragma solidity ^0.8.10;
	```

- Found in src/U3.sol [Line: 3](../tests/contract-playground/src/U3.sol#L3)

	```solidity
	pragma solidity ^0.8.10;
	```

- Found in src/U4.sol [Line: 2](../tests/contract-playground/src/U4.sol#L2)

	```solidity
	pragma solidity ^0.8.10;
	```

- Found in src/U5.sol [Line: 2](../tests/contract-playground/src/U5.sol#L2)
...
- Found in src/UnusedImport.sol [Line: 3](../tests/contract-playground/src/UnusedImport.sol#L3)
...
- Found in src/UnusedImport.sol [Line: 16](../tests/contract-playground/src/UnusedImport.sol#L16)
