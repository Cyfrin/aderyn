...
- Found in src/ReinitializerTest.sol [Line: 29](../tests/contract-playground/src/ReinitializerTest.sol#L29)
...
- Found in src/ReinitializerTest.sol [Line: 17](../tests/contract-playground/src/ReinitializerTest.sol#L17)

	```solidity
	    function initialize() external initializer {
	```

- Found in src/ReinitializerTest.sol [Line: 23](../tests/contract-playground/src/ReinitializerTest.sol#L23)
