...
- [High Issues](#high-issues)
  ...
  - [H-19: Sending native Eth is not protected from these functions.](#h-19-sending-native-eth-is-not-protected-from-these-functions)
  - [H-20: Delegatecall made by the function without checks on any adress.](#h-20-delegatecall-made-by-the-function-without-checks-on-any-adress)
...
## H-19: Sending native Eth is not protected from these functions.
...
- Found in src/Tower.sol [Line: 44](../tests/contract-playground/src/Tower.sol#L44)
...
## H-20: Delegatecall made by the function without checks on any adress.
...
- Found in src/SubWithoutIf.sol [Line: 2](../tests/contract-playground/src/SubWithoutIf.sol#L2)
...
- Found in src/SubWithoutIf.sol [Line: 12](../tests/contract-playground/src/SubWithoutIf.sol#L12)
...
- Found in src/SubWithoutIf.sol [Line: 18](../tests/contract-playground/src/SubWithoutIf.sol#L18)

	```solidity
	        if (magicNumber > 1000000) {
	```

- Found in src/SubWithoutIf.sol [Line: 19](../tests/contract-playground/src/SubWithoutIf.sol#L19)

	```solidity
	            return 500;
	```

- Found in src/SubWithoutIf.sol [Line: 21](../tests/contract-playground/src/SubWithoutIf.sol#L21)

	```solidity
	            return 100;
	```

- Found in src/SubWithoutIf.sol [Line: 28](../tests/contract-playground/src/SubWithoutIf.sol#L28)

	```solidity
	            uint256 magicNumber = subtractionContract.sub(a, b) + 4 ** 7;
	```

- Found in src/SubWithoutIf.sol [Line: 29](../tests/contract-playground/src/SubWithoutIf.sol#L29)

	```solidity
	            if (magicNumber > 1000000) {
	```

- Found in src/SubWithoutIf.sol [Line: 30](../tests/contract-playground/src/SubWithoutIf.sol#L30)

	```solidity
	                return 500;
	```

- Found in src/SubWithoutIf.sol [Line: 32](../tests/contract-playground/src/SubWithoutIf.sol#L32)

	```solidity
	                return 100;
	```

- Found in src/SubWithoutIf.sol [Line: 35](../tests/contract-playground/src/SubWithoutIf.sol#L35)

	```solidity
	        return 200;
	```

- Found in src/SubWithoutIf.sol [Line: 43](../tests/contract-playground/src/SubWithoutIf.sol#L43)

	```solidity
	        return 200;
	```

- Found in src/SubWithoutIf.sol [Line: 47](../tests/contract-playground/src/SubWithoutIf.sol#L47)

	```solidity
	        uint256 magicNumber = subtractionContract.sub(a, b) + 4 ** 7;
	```

- Found in src/SubWithoutIf.sol [Line: 48](../tests/contract-playground/src/SubWithoutIf.sol#L48)

	```solidity
	        if (magicNumber > 1000000) {
	```

- Found in src/SubWithoutIf.sol [Line: 49](../tests/contract-playground/src/SubWithoutIf.sol#L49)

	```solidity
	            return 500;
	```

- Found in src/SubWithoutIf.sol [Line: 51](../tests/contract-playground/src/SubWithoutIf.sol#L51)
...
- Found in src/Tower.sol [Line: 10](../tests/contract-playground/src/Tower.sol#L10)

	```solidity
	        require(msg.sender == address(0x11));
	```

- Found in src/Tower.sol [Line: 34](../tests/contract-playground/src/Tower.sol#L34)

	```solidity
	            revert();
	```

- Found in src/Tower.sol [Line: 61](../tests/contract-playground/src/Tower.sol#L61)

	```solidity
	            revert();
	```

- Found in src/Tower.sol [Line: 76](../tests/contract-playground/src/Tower.sol#L76)
...
- Found in src/Tower.sol [Line: 13](../tests/contract-playground/src/Tower.sol#L13)

	```solidity
	    modifier passThroughNinthFloor1() {
	```

- Found in src/Tower.sol [Line: 38](../tests/contract-playground/src/Tower.sol#L38)

	```solidity
	    modifier passThroughNinthFloor2(address x) {
	```

- Found in src/Tower.sol [Line: 65](../tests/contract-playground/src/Tower.sol#L65)
...
- Found in src/Tower.sol [Line: 19](../tests/contract-playground/src/Tower.sol#L19)
...
- Found in src/SubWithoutIf.sol [Line: 46](../tests/contract-playground/src/SubWithoutIf.sol#L46)

	```solidity
	    function doStuff(uint256 a, uint256 b) internal view returns(uint256) {
	```

- Found in src/Tower.sol [Line: 9](../tests/contract-playground/src/Tower.sol#L9)

	```solidity
	    function visitEighthFloor1() internal {
	```

- Found in src/Tower.sol [Line: 31](../tests/contract-playground/src/Tower.sol#L31)

	```solidity
	    function visitEighthFloor2(address x) internal {
	```

- Found in src/Tower.sol [Line: 58](../tests/contract-playground/src/Tower.sol#L58)

	```solidity
	    function visitEighthFloor3(address x) internal {
	```

- Found in src/Tower.sol [Line: 75](../tests/contract-playground/src/Tower.sol#L75)
