...
- [High Issues](#high-issues)
  ...
  - [H-23: Delegatecall made by the function without checks on any address.](#h-23-delegatecall-made-by-the-function-without-checks-on-any-address)
...
- [Low Issues](#low-issues)
  ...
  - [L-38: Void constructor](#l-38-void-constructor)
  - [L-39: Potentially missing inheritance for contract.](#l-39-potentially-missing-inheritance-for-contract)
  - [L-40: Unused Imports](#l-40-unused-imports)
  ...
  - [L-44: State variable could be declared immutable](#l-44-state-variable-could-be-declared-immutable)
  - [L-45: Modifier has multiple placeholders.](#l-45-modifier-has-multiple-placeholders)
...
| src/control_flow/SimpleProgram.sol | 187 |
...
## H-23: Delegatecall made by the function without checks on any address.
...
- Found in src/control_flow/SimpleProgram.sol [Line: 44](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L44)

	```solidity
	        if (mod > 12) mod += times;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 48](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L48)

	```solidity
	        if (mod > 12) mod += times;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 89](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L89)

	```solidity
	        for (uint256 i = 0; i < 100; ++i) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 97](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L97)

	```solidity
	        for (uint256 i = 0; i < 100; ++i) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 111](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L111)

	```solidity
	        } while (total < 10000);
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 126](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L126)

	```solidity
	            if (total < 300) break;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 127](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L127)

	```solidity
	            total *= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 128](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L128)

	```solidity
	        } while (total < 10000);
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 135](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L135)

	```solidity
	            for (uint256 i = 0; i < 100; ++i) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 136](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L136)

	```solidity
	                if (total < 300) break;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 137](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L137)

	```solidity
	                total -= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 139](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L139)

	```solidity
	            total *= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 140](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L140)

	```solidity
	        } while (total < 10000);
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 147](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L147)

	```solidity
	            while (total < 100) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 148](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L148)

	```solidity
	                if (total < 300) break;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 149](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L149)

	```solidity
	                total -= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 151](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L151)

	```solidity
	            total *= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 152](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L152)

	```solidity
	        } while (total < 10000);
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 159](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L159)

	```solidity
	            while (total < 100) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 160](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L160)

	```solidity
	                if (total < 300) continue;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 161](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L161)

	```solidity
	                total -= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 164](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L164)

	```solidity
	            total *= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 165](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L165)

	```solidity
	        } while (total < 10000);
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 172](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L172)

	```solidity
	            while (total < 100) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 173](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L173)

	```solidity
	                if (total < 300) break;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 174](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L174)

	```solidity
	                total -= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 177](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L177)

	```solidity
	            total *= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 183](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L183)

	```solidity
	        } while (total < 10000);
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 190](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L190)

	```solidity
	            while (total < 100) {
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 191](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L191)

	```solidity
	                if (total < 300) break;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 192](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L192)

	```solidity
	                total -= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 195](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L195)

	```solidity
	            total *= 3;
	```

- Found in src/control_flow/SimpleProgram.sol [Line: 204](../tests/contract-playground/src/control_flow/SimpleProgram.sol#L204)
...
## L-39: Potentially missing inheritance for contract.
...
## L-41: Function pointers used in constructors.
...
## L-42: State variable could be declared constant
...
## L-43: State variable changes but no event is emitted.
...
## L-44: State variable could be declared immutable
...
## L-45: Modifier has multiple placeholders.
