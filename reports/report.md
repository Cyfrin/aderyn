...
- [High Issues](#high-issues)
  ...
  - [H-23: Return value of the function call is not checked.](#h-23-return-value-of-the-function-call-is-not-checked)
...
- Found in src/MisusedBoolean.sol [Line: 10](../tests/contract-playground/src/MisusedBoolean.sol#L10)

	```solidity
	        if (isEven(num) || true) {
	```

- Found in src/MisusedBoolean.sol [Line: 17](../tests/contract-playground/src/MisusedBoolean.sol#L17)

	```solidity
	        if (isEven(num) && false) {
	```

- Found in src/MisusedBoolean.sol [Line: 24](../tests/contract-playground/src/MisusedBoolean.sol#L24)

	```solidity
	        if (false && isEven(num)) {
	```

- Found in src/MisusedBoolean.sol [Line: 31](../tests/contract-playground/src/MisusedBoolean.sol#L31)

	```solidity
	        if (true || isEven(num)) {
	```

- Found in src/MisusedBoolean.sol [Line: 38](../tests/contract-playground/src/MisusedBoolean.sol#L38)

	```solidity
	        if (true) {
	```

- Found in src/MisusedBoolean.sol [Line: 45](../tests/contract-playground/src/MisusedBoolean.sol#L45)
...
## H-23: Return value of the function call is not checked.
