...
- [Low Issues](#low-issues)
  ...
  - [L-32: State variable could be declared constant](#l-32-state-variable-could-be-declared-constant)
  - [L-33: State variable changes but no event is emitted.](#l-33-state-variable-changes-but-no-event-is-emitted)
...
| src/StateVariableCouldBeDeclaredConstant.sol | 23 |
...
- Found in src/StateVariableCouldBeDeclaredConstant.sol [Line: 2](../tests/contract-playground/src/StateVariableCouldBeDeclaredConstant.sol#L2)
...
## L-30: Function initializing state.
...
## L-32: State variable could be declared constant
...
## L-33: State variable changes but no event is emitted.
...
- Found in src/StateVariableCouldBeDeclaredConstant.sol [Line: 28](../tests/contract-playground/src/StateVariableCouldBeDeclaredConstant.sol#L28)

	```solidity
	    constructor() {
	```

- Found in src/StateVariableCouldBeDeclaredConstant.sol [Line: 35](../tests/contract-playground/src/StateVariableCouldBeDeclaredConstant.sol#L35)
