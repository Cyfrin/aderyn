...
- [Low Issues](#low-issues)
  ...
  - [L-32: Loop condition contains `state_variable.length` that could be cached outside.](#l-32-loop-condition-contains-statevariablelength-that-could-be-cached-outside)
  - [L-33: Incorrect use of `assert()`](#l-33-incorrect-use-of-assert)
  - [L-34: Costly operations inside loops.](#l-34-costly-operations-inside-loops)
  - [L-35: Builtin Symbol Shadowing](#l-35-builtin-symbol-shadowing)
...
## L-32: Loop condition contains `state_variable.length` that could be cached outside.
...
## L-34: Costly operations inside loops.
