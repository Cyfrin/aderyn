...
| src/StateVariablesManipulation.sol | 256 |
...
- Found in src/StateVariablesManipulation.sol [Line: 15](../tests/contract-playground/src/StateVariablesManipulation.sol#L15)

	```solidity
	    string public simpleString;
	```

- Found in src/StateVariablesManipulation.sol [Line: 16](../tests/contract-playground/src/StateVariablesManipulation.sol#L16)
...
- Found in src/StateVariablesManipulation.sol [Line: 151](../tests/contract-playground/src/StateVariablesManipulation.sol#L151)
...
- Found in src/StateVariablesManipulation.sol [Line: 65](../tests/contract-playground/src/StateVariablesManipulation.sol#L65)
...
- Found in src/StateVariablesManipulation.sol [Line: 130](../tests/contract-playground/src/StateVariablesManipulation.sol#L130)

	```solidity
	        person = Person("Spiderman", 21);
	```

- Found in src/StateVariablesManipulation.sol [Line: 132](../tests/contract-playground/src/StateVariablesManipulation.sol#L132)

	```solidity
	        person2.age = 21;
	```

- Found in src/StateVariablesManipulation.sol [Line: 201](../tests/contract-playground/src/StateVariablesManipulation.sol#L201)

	```solidity
	        p.age = 200;
	```

- Found in src/StateVariablesManipulation.sol [Line: 211](../tests/contract-playground/src/StateVariablesManipulation.sol#L211)

	```solidity
	        p2.age = 200;
	```

- Found in src/StateVariablesManipulation.sol [Line: 242](../tests/contract-playground/src/StateVariablesManipulation.sol#L242)

	```solidity
	        uint256[5][1] memory m_allAges;
	```

- Found in src/StateVariablesManipulation.sol [Line: 246](../tests/contract-playground/src/StateVariablesManipulation.sol#L246)

	```solidity
	        m_person = Person("Spiderman", 21);
	```

- Found in src/StateVariablesManipulation.sol [Line: 248](../tests/contract-playground/src/StateVariablesManipulation.sol#L248)

	```solidity
	        m_person2.age = 21;
	```

- Found in src/StateVariablesManipulation.sol [Line: 253](../tests/contract-playground/src/StateVariablesManipulation.sol#L253)

	```solidity
	        Person memory m_dummy = Person("Spiderman", 21);
	```

- Found in src/StateVariablesManipulation.sol [Line: 267](../tests/contract-playground/src/StateVariablesManipulation.sol#L267)

	```solidity
	        uint256[5] storage ageRef1 = allAges[0];
	```

- Found in src/StateVariablesManipulation.sol [Line: 273](../tests/contract-playground/src/StateVariablesManipulation.sol#L273)

	```solidity
	        uint256[5] storage ageRef2 = allAges[0];
	```

- Found in src/StateVariablesManipulation.sol [Line: 342](../tests/contract-playground/src/StateVariablesManipulation.sol#L342)

	```solidity
	        p.some.push(102);
	```

- Found in src/StateVariablesManipulation.sol [Line: 348](../tests/contract-playground/src/StateVariablesManipulation.sol#L348)
...
- Found in src/StateVariablesManipulation.sol [Line: 49](../tests/contract-playground/src/StateVariablesManipulation.sol#L49)

	```solidity
	    int256 public simpleInt = 100;
	```

- Found in src/StateVariablesManipulation.sol [Line: 50](../tests/contract-playground/src/StateVariablesManipulation.sol#L50)

	```solidity
	    bool public simpleBool = true;
	```

- Found in src/StateVariablesManipulation.sol [Line: 81](../tests/contract-playground/src/StateVariablesManipulation.sol#L81)
