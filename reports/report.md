...
- [Low Issues](#low-issues)
  ...
  - [L-24: State variable modification not logged in event](#l-24-state-variable-modification-not-logged-in-event)
...
| src/StateVariableEvents (copy).sol | 55 |
| src/StateVariableEvents.sol | 55 |
...
- Found in src/StateVariableEvents (copy).sol [Line: 4](../tests/contract-playground/src/StateVariableEvents (copy).sol#L4)

	```solidity
	contract StateVariableEvents {
	```

- Found in src/StateVariableEvents.sol [Line: 4](../tests/contract-playground/src/StateVariableEvents.sol#L4)
...
- Found in src/StateVariableEvents (copy).sol [Line: 20](../tests/contract-playground/src/StateVariableEvents (copy).sol#L20)

	```solidity
	    function stateChangedNoEventEmitted(uint a) public { // bad
	```

- Found in src/StateVariableEvents (copy).sol [Line: 24](../tests/contract-playground/src/StateVariableEvents (copy).sol#L24)

	```solidity
	    function addressChangedNotEmitted(address a) public { // bad
	```

- Found in src/StateVariableEvents (copy).sol [Line: 29](../tests/contract-playground/src/StateVariableEvents (copy).sol#L29)

	```solidity
	    function addressChangedEventEmitted(address a) public { // good
	```

- Found in src/StateVariableEvents (copy).sol [Line: 35](../tests/contract-playground/src/StateVariableEvents (copy).sol#L35)

	```solidity
	    function wholeStructChangedEventNotEmitted(uint a, uint b) public { // bad
	```

- Found in src/StateVariableEvents (copy).sol [Line: 41](../tests/contract-playground/src/StateVariableEvents (copy).sol#L41)

	```solidity
	    function wholeStructChangedEventEmitted(uint a, uint b) public { // good
	```

- Found in src/StateVariableEvents (copy).sol [Line: 47](../tests/contract-playground/src/StateVariableEvents (copy).sol#L47)

	```solidity
	    function structMemberChangedEventNotEmitted(uint a, uint b) public { // bad
	```

- Found in src/StateVariableEvents (copy).sol [Line: 53](../tests/contract-playground/src/StateVariableEvents (copy).sol#L53)

	```solidity
	    function structMemberChangedEventEmitted(uint a) public { // good
	```

- Found in src/StateVariableEvents (copy).sol [Line: 58](../tests/contract-playground/src/StateVariableEvents (copy).sol#L58)

	```solidity
	    function stateChangedEventEmitted(uint a) public { // good
	```

- Found in src/StateVariableEvents (copy).sol [Line: 64](../tests/contract-playground/src/StateVariableEvents (copy).sol#L64)

	```solidity
	    function stateChangedEventEmittedForLocal(uint a) public { // good
	```

- Found in src/StateVariableEvents (copy).sol [Line: 70](../tests/contract-playground/src/StateVariableEvents (copy).sol#L70)

	```solidity
	    function noStateChangedNoEventEmitted(uint a) public pure returns(uint){ // good
	```

- Found in src/StateVariableEvents.sol [Line: 20](../tests/contract-playground/src/StateVariableEvents.sol#L20)

	```solidity
	    function stateChangedNoEventEmitted(uint a) public { // bad
	```

- Found in src/StateVariableEvents.sol [Line: 24](../tests/contract-playground/src/StateVariableEvents.sol#L24)

	```solidity
	    function addressChangedNotEmitted(address a) public { // bad
	```

- Found in src/StateVariableEvents.sol [Line: 29](../tests/contract-playground/src/StateVariableEvents.sol#L29)

	```solidity
	    function addressChangedEventEmitted(address a) public { // good
	```

- Found in src/StateVariableEvents.sol [Line: 35](../tests/contract-playground/src/StateVariableEvents.sol#L35)

	```solidity
	    function wholeStructChangedEventNotEmitted(uint a, uint b) public { // bad
	```

- Found in src/StateVariableEvents.sol [Line: 41](../tests/contract-playground/src/StateVariableEvents.sol#L41)

	```solidity
	    function wholeStructChangedEventEmitted(uint a, uint b) public { // good
	```

- Found in src/StateVariableEvents.sol [Line: 47](../tests/contract-playground/src/StateVariableEvents.sol#L47)

	```solidity
	    function structMemberChangedEventNotEmitted(uint a, uint b) public { // bad
	```

- Found in src/StateVariableEvents.sol [Line: 52](../tests/contract-playground/src/StateVariableEvents.sol#L52)

	```solidity
	    function structMemberChangedEventEmitted(uint a) public { // good
	```

- Found in src/StateVariableEvents.sol [Line: 57](../tests/contract-playground/src/StateVariableEvents.sol#L57)

	```solidity
	    function stateChangedEventEmitted(uint a) public { // good
	```

- Found in src/StateVariableEvents.sol [Line: 63](../tests/contract-playground/src/StateVariableEvents.sol#L63)

	```solidity
	    function stateChangedEventEmittedForLocal(uint a) public { // good
	```

- Found in src/StateVariableEvents.sol [Line: 69](../tests/contract-playground/src/StateVariableEvents.sol#L69)
...
- Found in src/StateVariableEvents (copy).sol [Line: 15](../tests/contract-playground/src/StateVariableEvents (copy).sol#L15)

	```solidity
	    event variableChanged(uint outcome);
	```

- Found in src/StateVariableEvents (copy).sol [Line: 16](../tests/contract-playground/src/StateVariableEvents (copy).sol#L16)

	```solidity
	    event AddressChanged(address outcome);
	```

- Found in src/StateVariableEvents (copy).sol [Line: 17](../tests/contract-playground/src/StateVariableEvents (copy).sol#L17)

	```solidity
	    event MyStructChanged(MyStruct outcome);
	```

- Found in src/StateVariableEvents (copy).sol [Line: 18](../tests/contract-playground/src/StateVariableEvents (copy).sol#L18)

	```solidity
	    event MyStructMemberChanged(uint a);
	```

- Found in src/StateVariableEvents.sol [Line: 15](../tests/contract-playground/src/StateVariableEvents.sol#L15)

	```solidity
	    event variableChanged(uint outcome);
	```

- Found in src/StateVariableEvents.sol [Line: 16](../tests/contract-playground/src/StateVariableEvents.sol#L16)

	```solidity
	    event AddressChanged(address outcome);
	```

- Found in src/StateVariableEvents.sol [Line: 17](../tests/contract-playground/src/StateVariableEvents.sol#L17)

	```solidity
	    event MyStructChanged(MyStruct outcome);
	```

- Found in src/StateVariableEvents.sol [Line: 18](../tests/contract-playground/src/StateVariableEvents.sol#L18)
...
## L-24: State variable modification not logged in event
