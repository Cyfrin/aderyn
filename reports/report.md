...
| src/router/InternalCalls.sol | 127 |
| src/router/ModifierCalls.sol | 23 |
...
- Found in src/router/InternalCalls.sol [Line: 102](../tests/contract-playground/src/router/InternalCalls.sol#L102)

	```solidity
	    function ext2(uint256 a) public {}
	```

- Found in src/router/InternalCalls.sol [Line: 109](../tests/contract-playground/src/router/InternalCalls.sol#L109)

	```solidity
	    function main() public {
	```

- Found in src/router/InternalCalls.sol [Line: 150](../tests/contract-playground/src/router/InternalCalls.sol#L150)

	```solidity
	    function main() public {
	```

- Found in src/router/InternalCalls.sol [Line: 158](../tests/contract-playground/src/router/InternalCalls.sol#L158)

	```solidity
	    function main() public {
	```

- Found in src/router/InternalCalls.sol [Line: 166](../tests/contract-playground/src/router/InternalCalls.sol#L166)

	```solidity
	    function main() public {
	```

- Found in src/router/InternalCalls.sol [Line: 172](../tests/contract-playground/src/router/InternalCalls.sol#L172)
...
- Found in src/router/ModifierCalls.sol [Line: 34](../tests/contract-playground/src/router/ModifierCalls.sol#L34)
...
- Found in src/router/ModifierCalls.sol [Line: 30](../tests/contract-playground/src/router/ModifierCalls.sol#L30)
...
- Found in src/router/InternalCalls.sol [Line: 100](../tests/contract-playground/src/router/InternalCalls.sol#L100)
...
- Found in src/router/InternalCalls.sol [Line: 125](../tests/contract-playground/src/router/InternalCalls.sol#L125)

	```solidity
	    function priv() private {}
	```

- Found in src/router/InternalCalls.sol [Line: 131](../tests/contract-playground/src/router/InternalCalls.sol#L131)

	```solidity
	    function d() external virtual returns (uint256, bool, uint256) {}
	```

- Found in src/router/InternalCalls.sol [Line: 156](../tests/contract-playground/src/router/InternalCalls.sol#L156)

	```solidity
	    function free(uint256 x) external {}
	```

- Found in src/router/InternalCalls.sol [Line: 164](../tests/contract-playground/src/router/InternalCalls.sol#L164)
...
<details><summary>124 Found Instances</summary>


- Found in src/AbstractContract.sol [Line: 9](../tests/contract-playground/src/AbstractContract.sol#L9)
