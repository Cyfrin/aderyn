...
| src/CostlyOperationsInsideLoops.sol | 27 |
| src/Counter.sol | 20 |
...
- Found in src/CostlyOperationsInsideLoops.sol [Line: 30](../tests/contract-playground/src/CostlyOperationsInsideLoops.sol#L30)
...
- Found in src/CostlyOperationsInsideLoops.sol [Line: 23](../tests/contract-playground/src/CostlyOperationsInsideLoops.sol#L23)

	```solidity
	    function goodInitOnly() external {
	```

- Found in src/CostlyOperationsInsideLoops.sol [Line: 29](../tests/contract-playground/src/CostlyOperationsInsideLoops.sol#L29)
