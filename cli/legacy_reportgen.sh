...
cargo run -- --config-file ./tests/aderyn.config.json -o ./reports_legacy/report-config.md ./tests/contract-playground/ --skip-update-check --skip-build &
...
cargo run -- --config-file ./tests/aderyn.config.json -o ./reports_legacy/report-config.json ./tests/contract-playground/ --skip-update-check --skip-build &
