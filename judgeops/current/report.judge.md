...
| src/ParentChainContract.sol | 37 |
...
- Found in src/ParentChainContract.sol [Line: 44](../../tests/contract-playground/src/ParentChainContract.sol#L44)

	```solidity
	        uint256 inner = 1;
	```

- Found in src/ParentChainContract.sol [Line: 45](../../tests/contract-playground/src/ParentChainContract.sol#L45)

	```solidity
	        uint256 innerinner = 42;
	```

- Found in src/ParentChainContract.sol [Line: 51](../../tests/contract-playground/src/ParentChainContract.sol#L51)

	```solidity
	        uint256 innerinner = 42;
	```

- Found in src/ParentChainContract.sol [Line: 52](../../tests/contract-playground/src/ParentChainContract.sol#L52)

	```solidity
	        if (innerinner == 34) {
	```

- Found in src/ParentChainContract.sol [Line: 53](../../tests/contract-playground/src/ParentChainContract.sol#L53)
