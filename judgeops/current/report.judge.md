...
- Found in src/ConstantsLiterals.sol [Line: 7](../../tests/contract-playground/src/ConstantsLiterals.sol#L7)

	```solidity
	    address constant public CONSTANT_ADDRESS = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
	```

- Found in src/ConstantsLiterals.sol [Line: 8](../../tests/contract-playground/src/ConstantsLiterals.sol#L8)
