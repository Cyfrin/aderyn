...
- [High Issues](#high-issues)
  ...
  - [H-6: `SafeMath` library should be imported and used to prevent underflow and overflow in solidity compilers below `0.8.0`](#h-6-safemath-library-should-be-imported-and-used-to-prevent-underflow-and-overflow-in-solidity-compilers-below-080)
- [Low Issues](#low-issues)
  ...
  - [L-23: Contract elements should be laid out in the following order: `Type declarations` --> `State variables` --> `Events` --> `Errors` --> `Modifiers` --> `Functions`](#l-23-contract-elements-should-be-laid-out-in-the-following-order-type-declarations----state-variables----events----errors----modifiers----functions)
...
| src/ArithmeticUnderflowOverflow.sol | 96 |
...
solmate-safe-transfer-lib:Low

avoid-abi-encode-packed:High
...
useless-public-function:Low

constants-instead-of-literals:Low

unindexed-events:Low

require-with-string:Low

non-reentrant-before-others:Low

block-timestamp-deadline:High

unsafe-oz-erc721-mint:Low

push-zero-opcode:Low

arbitrary-transfer-from:High

useless-modifier:Low

empty-block:Low

large-numeric-literal:Low

useless-internal-function:Low

contract-with-todos:Low

inconsistent-type-names:Low

unprotected-initializer:High

arithmetic-underflow-overflow:High

useless-error:Low

reverts-and-requires-in-loops:Low

wrong-order-of-layout:Low

division-before-multiplication:Low
...
### Responsible : unprotected-initializer
...
## H-6: `SafeMath` library should be imported and used to prevent underflow and overflow in solidity compilers below `0.8.0`

Use `SafeMath` library for arithmetic operations to avoid underflow and/or overflow in solidity compilers below `0.8.0`

### Responsible : arithmetic-underflow-overflow

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 9](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L9)

	```solidity
	      result = num1 + num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 14](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L14)

	```solidity
	      result = num1 - num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 29](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L29)

	```solidity
	      counter += 1;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 34](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L34)

	```solidity
	      counter += 1;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 50](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L50)

	```solidity
	      result = num1 - num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 58](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L58)

	```solidity
	      result = num1 - num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 63](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L63)

	```solidity
	      uint256 result = num1 + num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 70](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L70)

	```solidity
	      uint256 result = num1 + num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 114](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L114)

	```solidity
	      counter += 1;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 120](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L120)
...
- Found in src/ArithmeticUnderflowOverflow.sol [Line: 8](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L8)

	```solidity
	    function add(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 13](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L13)

	```solidity
	    function sub(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 18](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L18)

	```solidity
	    function mul(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 23](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L23)

	```solidity
	    function div(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 28](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L28)

	```solidity
	    function incrementCounter() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 33](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L33)

	```solidity
	    function decrementCounter() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 38](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L38)

	```solidity
	    function incrementCounter2() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 43](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L43)

	```solidity
	    function decrementCounter2() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 48](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L48)

	```solidity
	    function subWithCheck(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 54](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L54)

	```solidity
	    function subWithCheck2(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 62](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L62)

	```solidity
	    function addWithCheck(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 69](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L69)

	```solidity
	    function addWithCheck2(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 78](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L78)

	```solidity
	    function mulWithCheck(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 87](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L87)

	```solidity
	    function mulWithCheck2(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 98](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L98)

	```solidity
	    function divWithCheck(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 104](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L104)

	```solidity
	    function divWithCheck2(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 112](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L112)

	```solidity
	    function incrementCounter3() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 118](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L118)

	```solidity
	    function decrementCounter3() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 124](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L124)

	```solidity
	    function incrementCounter4() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 132](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L132)
...
### Responsible : contract-with-todos
...
### Responsible : inconsistent-type-names
...
## L-23: Contract elements should be laid out in the following order: `Type declarations` --> `State variables` --> `Events` --> `Errors` --> `Modifiers` --> `Functions`
...
### Responsible : wrong-order-of-layout

- Found in src/Counter.sol [Line: 26](../../tests/contract-playground/src/Counter.sol#L26)

	```solidity
	    uint256 public constant TWO = 2;
	```

- Found in src/EmptyBlocks.sol [Line: 71](../../tests/contract-playground/src/EmptyBlocks.sol#L71)

	```solidity
	    event EmptyEvent();
	```

- Found in src/InconsistentUints.sol [Line: 10](../../tests/contract-playground/src/InconsistentUints.sol#L10)
...
- Found in src/StateVariables.sol [Line: 45](../../tests/contract-playground/src/StateVariables.sol#L45)

	```solidity
	    error ZeroAddressError();
	```

- Found in src/StorageConditionals.sol [Line: 15](../../tests/contract-playground/src/StorageConditionals.sol#L15)

	```solidity
	    event Same();
	```

- Found in src/StorageConditionals.sol [Line: 57](../../tests/contract-playground/src/StorageConditionals.sol#L57)
...
- Found in src/WrongOrderOfLayout.sol [Line: 7](../../tests/contract-playground/src/WrongOrderOfLayout.sol#L7)

	```solidity
	    struct Allowed {
	```

- Found in src/WrongOrderOfLayout.sol [Line: 15](../../tests/contract-playground/src/WrongOrderOfLayout.sol#L15)
...
### Responsible : division-before-multiplication
