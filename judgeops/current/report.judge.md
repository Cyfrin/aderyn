...
| src/ArithmeticUnderflowOverflow.sol | 16 |
...
- Found in src/ArithmeticUnderflowOverflow.sol [Line: 12](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L12)

	```solidity
	      result = num1 - num2;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 16](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L16)

	```solidity
	      counter += 1;
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 20](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L20)
...
- Found in src/DivisionBeforeMultiplication.sol [Line: 24](../../tests/contract-playground/src/DivisionBeforeMultiplication.sol#L24)

	```solidity
	        result = a + b * b / c + b * c; 
	```

- Found in src/DivisionBeforeMultiplication.sol [Line: 28](../../tests/contract-playground/src/DivisionBeforeMultiplication.sol#L28)
...
- Found in src/ArithmeticUnderflowOverflow.sol [Line: 7](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L7)

	```solidity
	    function add(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 11](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L11)

	```solidity
	    function sub(uint256 num1, uint256 num2) public pure returns (uint256 result) {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 15](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L15)

	```solidity
	    function incrementCounter() public {
	```

- Found in src/ArithmeticUnderflowOverflow.sol [Line: 19](../../tests/contract-playground/src/ArithmeticUnderflowOverflow.sol#L19)
