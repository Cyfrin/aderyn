...
- [NC Issues](#nc-issues)
  ...
  - [NC-3: Define and use `constant` variables instead of literals](#nc-3-define-and-use-constant-variables-instead-of-literals)
...
## NC-3: Define and use `constant` variables instead of literals
