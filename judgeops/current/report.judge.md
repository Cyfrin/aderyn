...
- Found in src/AdminContract.sol [Line: 8](../../tests/contract-playground/src/AdminContract.sol#L8)

	```solidity
	contract AdminContract is Ownable, ReentrancyGuard {
	```

- Found in src/AdminContract.sol [Line: 11](../../tests/contract-playground/src/AdminContract.sol#L11)

	```solidity
	    function setOwner(address _owner) external onlyOwner nonReentrant {
	```

- Found in src/AdminContract.sol [Line: 15](../../tests/contract-playground/src/AdminContract.sol#L15)
...
- Found in src/inheritance/FourthLevel.sol [Line: 2](../../tests/contract-playground/src/inheritance/FourthLevel.sol#L2)
...
Unused import, consider removing it.

### Responsible : unused-imports

- Found in src/AdminContract.sol [Line: 6](../../tests/contract-playground/src/AdminContract.sol#L6)
