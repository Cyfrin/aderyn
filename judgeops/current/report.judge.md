...
- [NC Issues](#nc-issues)
  ...
  - [NC-7: Public constants can be replaced by single getter function](#nc-7-public-constants-can-be-replaced-by-single-getter-function)
  - [NC-8: Modifiers invoked only once can be shoe-horned into the function](#nc-8-modifiers-invoked-only-once-can-be-shoe-horned-into-the-function)
...
public-constant:NC (Non Critical)
...
### Responsible : public-constant

- Found in src/ConstantsLiterals.sol [Line: 4](../../tests/contract-playground/src/ConstantsLiterals.sol#L4)

	```solidity
	contract ConstantsLiterals {
	```

- Found in src/HugeConstants.sol [Line: 4](../../tests/contract-playground/src/HugeConstants.sol#L4)
...
## NC-8: Modifiers invoked only once can be shoe-horned into the function
