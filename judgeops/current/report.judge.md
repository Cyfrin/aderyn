...
- [Low Issues](#low-issues)
  ...
  - [L-7: Use abi.encodeCall for typesafety instead of abi.encodeWithSignature (or) abi.encodeWithSelector ](#l-7-use-abiencodecall-for-typesafety-instead-of-abiencodewithsignature-or-abiencodewithselector-)
  - [L-8: Unprotected initializer](#l-8-unprotected-initializer)
  - [L-9: Using `keccak256` produces weak randomness and is predicatable.](#l-9-using-keccak256-produces-weak-randomness-and-is-predicatable)
- [NC Issues](#nc-issues)
  ...
  - [NC-8: Empty Block](#nc-8-empty-block)
  - [NC-9: Large literal values multiples of 10000 can be replaced with scientific notation](#nc-9-large-literal-values-multiples-of-10000-can-be-replaced-with-scientific-notation)
  - [NC-10: Internal functions called only once can be inlined](#nc-10-internal-functions-called-only-once-can-be-inlined)
...
useless-modifier:NC (Non Critical)

empty-block:NC (Non Critical)

large-numeric-literal:NC (Non Critical)

useless-internal-function:NC (Non Critical)

non-typesafe-abi-encode:Low
...
- Found in src/ABIEncode.sol [Line: 33](../../tests/contract-playground/src/ABIEncode.sol#L33)

	```solidity
	        return abi.encodeWithSelector(IERC20.transfer.selector, to, amount);
	```

- Found in src/ABIEncode.sol [Line: 42](../../tests/contract-playground/src/ABIEncode.sol#L42)
...
- Found in src/ABIEncode.sol [Line: 2](../../tests/contract-playground/src/ABIEncode.sol#L2)
...
## L-7: Use abi.encodeCall for typesafety instead of abi.encodeWithSignature (or) abi.encodeWithSelector 

Solidity compiler can type check for functions at compile time when abi.encodeCall is used. That doesn't happen in cases where abi.encodeWithSignature (or) abi.encodeWithSelector is used.

### Responsible : non-typesafe-abi-encode

- Found in src/ABIEncode.sol [Line: 24](../../tests/contract-playground/src/ABIEncode.sol#L24)
...
## L-9: Using `keccak256` produces weak randomness and is predicatable.

Consider using Chainlink VRF (Verifiable Random Function). It is a provably fair and verifiable random number generator (RNG) that enables smart contracts to access random values without compromising security or usability. For each request, Chainlink VRF generates one or more random values and cryptographic proof of how those values were determined. The proof is published and verified onchain before any consuming applications can use it. This process ensures that results cannot be tampered with or manipulated by any single entity including oracle operators, miners, users, or smart contract developers.

### Responsible : weak-randomness

- Found in src/WeakRandomness.sol [Line: 10](../../tests/contract-playground/src/WeakRandomness.sol#L10)
...
- Found in src/WeakRandomness.sol [Line: 8](../../tests/contract-playground/src/WeakRandomness.sol#L8)
...
- Found in src/ABIEncode.sol [Line: 9](../../tests/contract-playground/src/ABIEncode.sol#L9)
...
## NC-9: Large literal values multiples of 10000 can be replaced with scientific notation
...
## NC-10: Internal functions called only once can be inlined
