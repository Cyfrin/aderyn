...
- [Low Issues](#low-issues)
  ...
  - [L-25: Functions which modify state should emit an event.](#l-25-functions-which-modify-state-should-emit-an-event)
...
- Found in src/MissingEvent.sol [Line: 13](../../tests/contract-playground/src/MissingEvent.sol#L13)

	```solidity
	      owner = _owner;
	```

- Found in src/MissingEvent.sol [Line: 23](../../tests/contract-playground/src/MissingEvent.sol#L23)
...
- Found in src/MissingEvent.sol [Line: 16](../../tests/contract-playground/src/MissingEvent.sol#L16)

	```solidity
	    function updateStartDate(uint256 _startDate) public {
	```

- Found in src/MissingEvent.sol [Line: 22](../../tests/contract-playground/src/MissingEvent.sol#L22)
...
- Found in src/MissingEvent.sol [Line: 2](../../tests/contract-playground/src/MissingEvent.sol#L2)
...
## L-25: Functions which modify state should emit an event.

Functions which modify state should emit an event.

### Responsible : missing-event
...
- Found in src/InternalFunctions.sol [Line: 23](../../tests/contract-playground/src/InternalFunctions.sol#L23)
