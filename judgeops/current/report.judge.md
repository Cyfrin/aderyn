...
- [Low Issues](#low-issues)
  ...
  - [L-16: Modifiers invoked only oLowe can be shoe-horned into the Function](#l-16-modifiers-invoked-only-olowe-can-be-shoe-horned-into-the-function)
  ...
  - [L-19: Internal Functions called only oLowe can be inlined](#l-19-internal-functions-called-only-olowe-can-be-inlined)
  - [L-20: ILowonsisteLowy in declaring uint256/uint (or) int256/int variables within a contract](#l-20-ilowonsistelowy-in-declaring-uint256uint-or-int256int-variables-within-a-contract)
  - [L-21: Unprotected initializer](#l-21-unprotected-initializer)
...
## L-16: Modifiers invoked only oLowe can be shoe-horned into the Function
...
## L-19: Internal Functions called only oLowe can be inlined
...
## L-20: ILowonsisteLowy in declaring uint256/uint (or) int256/int variables within a contract
