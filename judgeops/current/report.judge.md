...
- [Low Issues](#low-issues)
  ...
  - [L-7: create2 opcode should be used instead of create](#l-7-create2-opcode-should-be-used-instead-of-create)
- [NC Issues](#nc-issues)
...
- Found in src/Create.sol [Line: 4](../../tests/contract-playground/src/Create.sol#L4)
...
## L-7: create2 opcode should be used instead of create

create2 makes deployment addresses consistent and is less susceptible to chain reorg attacks especially in L2 scaling solutions

### Responsible : create2-instead-of-create

- Found in src/Create.sol [Line: 23](../../tests/contract-playground/src/Create.sol#L23)

	```solidity
	        Car car = new Car(_owner, _model);
	```

- Found in src/Create.sol [Line: 32](../../tests/contract-playground/src/Create.sol#L32)

	```solidity
	        Car car = (new Car){value: msg.value}(_owner, _model);
	```

- Found in src/Create.sol [Line: 41](../../tests/contract-playground/src/Create.sol#L41)
...
- Found in src/Create.sol [Line: 12](../../tests/contract-playground/src/Create.sol#L12)
...
- Found in src/Create.sol [Line: 21](../../tests/contract-playground/src/Create.sol#L21)

	```solidity
	    function create(address _owner, string memory _model) public {
	```

- Found in src/Create.sol [Line: 27](../../tests/contract-playground/src/Create.sol#L27)

	```solidity
	    function createAndSendEther(address _owner, string memory _model)
	```

- Found in src/Create.sol [Line: 36](../../tests/contract-playground/src/Create.sol#L36)

	```solidity
	     function createAndSendEther2(address _owner, string memory _model)
	```

- Found in src/Create.sol [Line: 45](../../tests/contract-playground/src/Create.sol#L45)

	```solidity
	    function create2(address _owner, string memory _model, bytes32 _salt)
	```

- Found in src/Create.sol [Line: 53](../../tests/contract-playground/src/Create.sol#L53)

	```solidity
	    function create2AndSendEther(
	```

- Found in src/Create.sol [Line: 63](../../tests/contract-playground/src/Create.sol#L63)
