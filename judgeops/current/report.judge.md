...
- [NC Issues](#nc-issues)
  ...
  - [NC-7: Internal functions called only once can be inlined](#nc-7-internal-functions-called-only-once-can-be-inlined)
...
- Found in src/InternalFunctions.sol [Line: 2](../../tests/contract-playground/src/InternalFunctions.sol#L2)
...
## NC-7: Internal functions called only once can be inlined
