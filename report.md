...
- Found in src/ConstantsLiterals.sol [Line: 18](tests/contract-playground/src/ConstantsLiterals.sol#L18)

	```solidity
	        uint multipleUseOfValue = 987;
	```

- Found in src/ConstantsLiterals.sol [Line: 19](tests/contract-playground/src/ConstantsLiterals.sol#L19)

	```solidity
	        multipleUseOfValue = 987;
	```

- Found in src/ConstantsLiterals.sol [Line: 20](tests/contract-playground/src/ConstantsLiterals.sol#L20)

	```solidity
	        uint multipleUseOfValue2 = 9876;
	```

- Found in src/ConstantsLiterals.sol [Line: 21](tests/contract-playground/src/ConstantsLiterals.sol#L21)
