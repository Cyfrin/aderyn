...
impl IssueDetector for TemplateDetector {
    ...
    fn title(&self) -> String {
        String::from("NC Issue Title")
    }

    fn description(&self) -> String {
        String::from("Description of the NC issue.")
    }
...
mod arbitrary_transfer_from_tests {
    use crate::detect::{
        ...
        NC::arbitrary_transfer_from::ArbitraryTransferFromDetector,
    };
    ...
    fn test_arbitrary_transfer_from_detector() {
        ...
        // assert the severity is NC
        assert_eq!(
            detector.severity(),
            crate::detect::detector::IssueSeverity::NC
        );
        // assert the title is correct
        assert_eq!(detector.title(), String::from("NC Issue Title"));
