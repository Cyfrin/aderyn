...
use super::{low::Create2InsteadOfCreateDetector, nc::EmptyBlockDetector};
...
pub fn get_all_issue_detectors() -> Vec<Box<dyn IssueDetector>> {
    vec![
        ...
        Box::<Create2InsteadOfCreateDetector>::default(),
    ]
}
...
pub fn request_issue_detector_by_name(detector_name: &str) -> Option<Box<dyn IssueDetector>> {
    ...
    match detector_name {
        ...
        IssueDetectorNamePool::Create2InsteadOfCreate => {
            Some(Box::<Create2InsteadOfCreateDetector>::default())
        }
