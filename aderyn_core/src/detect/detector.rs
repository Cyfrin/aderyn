...
use super::nc::{EmptyBlockDetector, LibraryHasPublicOrExternalFunctionsDetector};
...
pub fn get_all_issue_detectors() -> Vec<Box<dyn IssueDetector>> {
    vec![
        ...
        Box::<LibraryHasPublicOrExternalFunctionsDetector>::default(),
    ]
}
...
pub(crate) enum IssueDetectorNamePool {
    ...
    EmptyBlock,
    LibraryHasPublicOrExternalFunctions,
...
pub fn request_issue_detector_by_name(detector_name: &str) -> Option<Box<dyn IssueDetector>> {
    ...
    match detector_name {
        ...
        IssueDetectorNamePool::LibraryHasPublicOrExternalFunctions => {
            Some(Box::<LibraryHasPublicOrExternalFunctionsDetector>::default())
        }
