...
use crate::{
    ...
    detect::{
        high::{
            ...
            TautologicalCompareDetector, UncheckedReturnDetector, UnimplementedFunctionsDetector,
...
pub fn get_all_issue_detectors() -> Vec<Box<dyn IssueDetector>> {
    vec![
        ...
        Box::<UnimplementedFunctionsDetector>::default(),
    ]
}
...
pub fn request_issue_detector_by_name(detector_name: &str) -> Option<Box<dyn IssueDetector>> {
    ...
    match detector_name {
        ...
        IssueDetectorNamePool::UnimplementedFunctions => {
            Some(Box::<UnimplementedFunctionsDetector>::default())
        }
