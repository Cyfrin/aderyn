...
impl IssueDetector for TemplateDetector {
    ...
    fn title(&self) -> String {
        String::from("Medium Issue Title")
    }

    fn description(&self) -> String {
        String::from("Description of the Medium issue.")
    }
...
mod arbitrary_transfer_from_tests {
    use crate::detect::{
        ...
        Medium::arbitrary_transfer_from::ArbitraryTransferFromDetector,
    };
    ...
    fn test_arbitrary_transfer_from_detector() {
        ...
        assert_eq!(detector.title(), String::from("Medium Issue Title"));
