...
pub(crate) mod clz_legacy;
pub(crate) mod clz_signed_integer;
...
pub use clz_legacy::ClzLegacyImplementationsDetector;
pub use clz_signed_integer::ClzSignedIntegerDetector;
